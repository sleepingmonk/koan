import{t as i,D as l,a as c,T as r}from"./twig-CReQIq0G.js";import"./iframe-BWpVt3rS.js";import"./preload-helper-D9Z9MdNV.js";const u=`# Drupal Integration
...
`;c(r);r.cache(!1);const a=e=>e,s=(e={})=>{const o=i.twig({id:"/home/runner/work/koan/koan/stories/Documentation/DrupalIntegration/DrupalIntegration.twig",data:[{type:"raw",value:`<div class="principal center">
  See Docs.
</div>
`,position:{start:0,end:0}}],precompiled:!0});o.options.allowInlineIncludes=!0;try{let t=e.defaultAttributes?e.defaultAttributes:[];return Array.isArray(t)||(t=Object.entries(t)),a(o.render({attributes:new l(t),...e}))}catch(t){return a("An error occurred whilst rendering /home/runner/work/koan/koan/stories/Documentation/DrupalIntegration/DrupalIntegration.twig: "+t.toString())}},y={title:"Documentation/DrupalIntegration",component:s,parameters:{layout:"centered",docs:{description:{component:u}}}},m=({...e})=>s({...e}),n=m.bind({});n.args={};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`({
  ...args
}) => {
  return Component({
    ...args
